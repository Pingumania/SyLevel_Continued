...
function P.createFontString(parent, template)
...
function P.createCheckBox(parent)
...
P.FullAlign = {TOPLEFT = "TOPLEFT",TOP = "TOP",TOPRIGHT = "TOPRIGHT",LEFT = "LEFT",CENTER = "CENTER",RIGHT = "RIGHT",BOTTOMLEFT = "BOTTOMLEFT",BOTTOM = "BOTTOM",BOTTOMRIGHT = "BOTTOMRIGHT"}

P.Hex = function(r, g, b)
...
do
	...
	function P.createEditBox(self, name, width, height, type, max)
		local editbox = CreateFrame("EditBox", P.Name.."_Editbox_"..name, self)
		if type then
			editbox:SetNumeric()
		end
...
do
	function P.createSlider(self, name, minv, maxv, step)
...
do
	...
	function P.createColorSwatch(self)
